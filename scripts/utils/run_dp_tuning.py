...
def get_args():
    ...
    parser.add_argument("--logical-batch-size", type=int, default=4, help="Logical batch size for DP accumulation")
...
def main():
    ...
    try:
        for round_num in range(1, args.num_rounds + 1):
            ...
            # Sequentially run each client to respect VRAM
            for center_id in range(3):
                ...
                config = {"round": round_num, "lr": 1e-6} # Ultra low for stability
